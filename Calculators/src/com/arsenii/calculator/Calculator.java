		...
		while (run.equals("Y")) {
			try {
		        ...
		        if (isEnough.isEnoughTokens(3, problem)) {
		    		...
		    		int slashIndexA = A.indexOf('/');
		            String numeratorA = A.substring(0, slashIndexA);
		            String denominatorA = A.substring(slashIndexA + 1);
		    	...
		    	if (B.contains("/") == false) {
		            ...
		            int slashIndexB = B.indexOf('/');
		            String numeratorB = B.substring(0, slashIndexB);
		            String denominatorB = B.substring(slashIndexB + 1);
